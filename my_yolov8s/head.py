...
class Detect(nn.Module):
    """YOLOv8 检测头 处理多尺度特征图，输出边界框和类别预测 完全兼容 ultralytics.nn.modules.head.Detect.
    """
    ...
    def __init__(self, nc=80, reg_max=16, ch=()):
        """参数: nc: 类别数 (number of classes) reg_max: DFL 分布的最大通道数 ch: 输入通道列表，对应不同尺度的特征图.
        """
        super().__init__()
        self.nc = nc  # 类别数
